...
import Stream.AdaptationSetStream;
import Utils.AdaptationSetHelper;
import Utils.IOUtils;
import dash.manager.DASHManager;
...
public class TesterDownloader {
    ...
    public void get(String av) throws IOException, DocumentException {
